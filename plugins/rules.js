...
`.trim(), 'Kebijakan ©2022 By Alwi Ezy', '⋮☰ Menu', '.menu', 'Owner', '.nowner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            ...
            mediaType: 2,
          thumbnail: await (await fetch('https://telegra.ph/file/722c4f76d65acb2f765b7.jpg')).buffer(),
